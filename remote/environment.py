...
class Environment(object):
    ...
    def pull_and_run_docker_container(self, workspace, project_settings):
        ...
        if len(active_containers) > 0:
            ...
            docker_image = project_settings['remote_settings']['docker_image'].split(':')[0]
            progress = apic.pull(docker_image, 'latest', stream=True,
            ...
            c = dc.containers.run(docker_image + ':latest',
                                  environment={
